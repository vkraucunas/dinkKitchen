...
getFunction('//jsonip.com', 'ip').then(function(ip) {
  ...
  var City = city;
  var lastURL = '//api.openweathermap.org/data/2.5/weather?q='+City+'&units=imperial&APPID=f708ff06c29d9c50b54499dfec6a5a05';
  ...
  var Trello = $.ajax({
    url: "//api.trello.com/1/boards/56a997d37317034310b39031/lists?cards=open&card_fields=all&fields=name&key=c08e97c955fd88aba5f367ed9c47c0d4&token=9767918595f60e414fe3c1db21b106abc15fe9f3228609b9e68c265e12b9595c",
    method: "GET",
